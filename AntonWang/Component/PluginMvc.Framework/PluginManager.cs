...
namespace PluginMvc.Framework
{
    ...
    public static class PluginManager
    {
        ...
        ///     插件字典。
        /// </summary>
        private static readonly IDictionary<string, PluginDescriptor> _plugins =
            new Dictionary<string, PluginDescriptor>();
        ...
        {
            //遍历所有插件描述。
            IEnumerable<PluginDescriptor> plugins = PluginLoader.Load();
        ...
        {
            //卸载所有插件。
            foreach (PluginDescriptor plugin in PluginLoader.Load())
            {
        ...
        public static void MarkPluginAsInstalled(string systemName)
        {
            ...
            string filePath = PluginLoader.GetInstalledPluginsFilePath();
            ...
            IList<string> installedPluginSystemNames =
                PluginFileParser.ParseInstalledPluginsFile(PluginLoader.GetInstalledPluginsFilePath());
