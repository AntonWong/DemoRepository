...
namespace PluginMvc.Framework.Mvc
{
    public abstract class ThemeableVirtualPathProviderViewEngine : VirtualPathProviderViewEngine
    {
            ...
            bool useCache, out string[] searchedLocations)
        {
            ...
            if (viewLocations.Count == 0)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture,
                    "Properties cannot be null or empty.", new object[] {locationsPropertyName}));
            }
            ...
            if (useCache)
            {
                string cached = ViewLocationCache.GetViewLocation(controllerContext.HttpContext, key);
                if (cached != null)
                {
                    return cached;
                }
            ...
            if (!flag2)
            {
                return GetPathFromGeneralName(controllerContext, viewLocations, name, controllerName, areaName, theme,
        ...
        protected virtual List<ViewLocation> GetViewLocations(string[] viewLocationFormats,
        ...
        protected virtual string GetAreaName(RouteData routeData)
        {
            ...
            {
                string pluginName = routeData.GetRequiredString("pluginName");
                return pluginName;
            }
        ...
        protected virtual string GetAreaName(RouteBase route)
        {
            ...
            if ((route2 != null) && (route2.DataTokens != null) && (route2.DataTokens.ContainsKey("pluginName")))
            {
                ...
                Trace.WriteLine(route2.DataTokens["pluginName"].ToString());
            ...
            string masterName, bool useCache)
        {
            ...
            string str2 = GetPath(controllerContext, ViewLocationFormats, AreaViewLocationFormats, "ViewLocationFormats",
                viewName, requiredString, theme, "View", useCache, out strArray);
            string str3 = GetPath(controllerContext, MasterLocationFormats, AreaMasterLocationFormats,
            ...
            string partialViewName, bool useCache)
        {
            ...
            string theme = GetCurrentTheme();
            string requiredString = controllerContext.RouteData.GetRequiredString("controller");
            string str2 = GetPath(controllerContext, PartialViewLocationFormats, AreaPartialViewLocationFormats,
        ...
        private void CodeGeneration(string pluginName)
        {
            RazorBuildProvider.CodeGenerationStarted += (object sender, EventArgs e) =>
            {
                ...
                if (plugin != null)
                {
                    ...
                    {
                        foreach (Assembly assem in plugin.DependentAssemblys)
                        {
