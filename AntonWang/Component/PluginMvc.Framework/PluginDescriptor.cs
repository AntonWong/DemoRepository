...
namespace PluginMvc.Framework
{
    ...
    public class PluginDescriptor
    {
        ...
        public PluginDescriptor(IPlugin plugin, Assembly assembly, IEnumerable<Type> types,
            IEnumerable<Assembly> dependentAssemblys = null)
        {
            Plugin = plugin;
            Assembly = assembly;
            Types = types;
        ...
        public void Init(IPlugin plugin, IEnumerable<Assembly> assemblies)
        {
            Plugin = plugin;
            ...
            IEnumerable<Assembly> assems = assemblies;
                //.Where(p => plugin.DependentAssembly.Contains(p.GetName().Name)).ToList();
